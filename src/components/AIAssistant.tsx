        ...
        <Tabs defaultValue="chat" className="flex-1 flex flex-col min-h-0">
          ...
          <TabsContent value="chat" className="flex-1 flex flex-col min-h-0 mt-0">
            <div className="flex-1 overflow-auto p-4 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2 pt-2">
                {suggestions.map((s) => (
                  <button
                    key={s}
                    className="rounded-lg border bg-card px-3 py-2 text-left text-xs hover:border-brand hover:shadow-elegant transition-all"
                  >
                    <Sparkles className="h-3 w-3 text-brand inline mr-1.5" />
                    {s}
                  </button>
                ))}
              </div>
            ...
            <div className="border-t p-3 flex gap-2">
              ...
              <Button size="icon" className="bg-gradient-brand">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    18 bank transactions categorized. Review 3 flagged entries before posting.
                  </p>
            ...
            <Card className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    AWS spend up 22% vs 3-month average. Cause: EC2 spot instances in ap-south-1.
                  </p>
                </div>
              </div>
            </Card>
            <Card className="p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Match NEFT ₹2,85,000 with INV-2026-0148 (Reliance Retail). Confidence 98%.
                  </p>
                  <Button size="sm" className="mt-2 bg-gradient-brand">
                    Auto-match
                  </Button>
                </div>
              </div>
          ...
          <TabsContent value="cfo" className="flex-1 overflow-auto p-4 space-y-3 mt-0">
            <Card className="p-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Revenue grew <span className="text-foreground font-medium">12.4% MoM</span> to ₹6.8
                Cr, driven by Peripherals (+28%) and Displays (+18%). Gross margin held at 42.3%.
                Operating cash flow of ₹2.1 Cr is strong; recommend deploying ₹80L into 90-day FD
                ladder. Watch: AR days rose to 41 (from 34) — trigger collection cadence on top-3
                debtors.
              </p>
            </Card>
            <Card className="p-4">
                ...
                {[
                  ...
                  <div key={r.k} className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className={r.warn ? "text-warning text-xs" : "text-success text-xs"}>
                        {r.d}
                      </span>
                    </div>
                  </div>
